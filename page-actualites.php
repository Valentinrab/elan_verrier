...
<body>
  ...
  <section class="container">
    <main class="container-main">
      ...
      <svg version="1.1" id="main-interview" class="illustration illustration1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        ...
        <section id="content_actu_article" class="row">
          <?php
  				...
  				while ( $the_query->have_posts() ) {
  							$the_query -> the_post();
                ?>
                <article class="actu_reveal <?php the_field('categorie'); ?> col-10 offset-1 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
