...
<g id="texte">
	...
	<path class="st4" d="M120.5,117.1c2.3-0.1,4.7,0.4,6.7,1.6c1.6,1.1,2.5,2.9,2.3,4.8c0.1,1.2-0.3,2.3-0.9,3.3
      ...
      <!-- <div class="animation-logo col-12 col-lg-4 offset-lg-4 col-sm-6 offset-sm-3">
        ...
        <div id="scene">
          <img class="tache-1" src="<?php bloginfo('template_directory'); ?>/images/logo-anime/proposition-final-tache-1.svg" alt="tache">
          <img class="tache-2" src="<?php bloginfo('template_directory'); ?>/images/logo-anime/proposition-final-tache-2.svg" alt="tache">
          <img class="tache-3" src="<?php bloginfo('template_directory'); ?>/images/logo-anime/proposition-final-tache-3.svg" alt="tache">
        </div>
