  ...
  <body>
    ...
    <section class="container">
      ...
      <main id="content_video">
        <!-- <img src="images/accueil.jpg" class="video" alt="image de présentation d'Elan Verrier"> -->
        <img src="images/taches/accueil_1.svg" class="tache tache1" alt="tache">
        <div class="video set_bg" style="background-image:url('images/accueil.jpg')">
          <div class="next_ev">
            <p>PROCHAINEMENT</p>
          </div>
        </div>
      ...
      <section id="content_about" class="mt-150px row">
        ...
        <img src="images/taches/accueil_2.svg" class="tache tache2" alt="tache">
        <img src="images/illustrations/mains.png" class="illustration illustration1" alt="illustration">
        <div class="content_image col-12 col-lg-6 offset-lg-0">
          <div class="image_l set_bg col-8 offset-2 col-lg-8 offset-lg-0" style="background-image:url('images/crea4.jpg');"></div>
          <div class="image_r set_bg col-8 offset-lg-4" style="background-image:url('images/crea5.jpg');"></div>
        </div>
      </section>

      <section id="content_activites" class="mt-150px row">
        <img src="images/taches/accueil_3.svg" class="tache tache3" alt="tache">
        <img src="images/illustrations/soufflage.png" class="illustration illustration2" alt="illustration">
        <div class="content_image col-12 col-lg-6">
          <div class="image_l set_bg col-8 offset-2 col-lg-12 offset-lg-0" style="background-image:url('images/crea7.jpg');"></div>
        </div>
        <div class="content_texte col-8 offset-2 col-lg-5 offset-lg-0">
      ...
      <section id="content_actu" class="mt-150px">
        ...
        <section id="content_actu_article" class="row">
          ...
          <div class="content_actu_secondary col-12 col-lg-6">
            <article class="actu_secondary">
              <div class="actu_secondary_image set_bg col-sm-6" style="background-image:url('images/crea5.jpg')"></div>
        ...
        <img src="images/taches/accueil_4.svg" class="tache tache4" alt="tache">
        <img src="images/illustrations/feu.png" class="illustration illustration3" alt="illustration">
      ...
      <section id="content_realisation" class="mt-150px">
        ...
        <img src="images/illustrations/vase.png" class="illustration illustration4" alt="illustration">
        <section id="content_realisation_article">
          <div class="realisation_img col-8 offset-2 col-lg-4 offset-lg-0" style="background-image:url('images/crea5.jpg')"></div>
          <div class="content_realisation_img col-lg-4">
            <div class="realisation_img col-sm-12" style="background-image:url('images/crea1.jpg')"></div>
            <div class="realisation_img col-sm-12" style="background-image:url('images/crea3.jpg')"></div>
          </div>
          <div class="realisation_img col-8 offset-2 col-lg-4 offset-lg-0" style="background-image:url('images/crea5.jpg')"></div>
        </section>
        <a href="#" class="btn_access">VOIR TOUTES LES REALISATIONS</a>
        <img src="images/taches/accueil_5.svg" class="tache tache5" alt="tache">
      </section>
